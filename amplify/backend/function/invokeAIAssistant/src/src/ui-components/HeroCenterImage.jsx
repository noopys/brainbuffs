...
export default function HeroCenterImage(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "HeroCenterImage")}
      {...rest}
    >
      <View
        width="1440px"
        ...
        {...getOverrideProps(overrides, "Background0182")}
      ></View>
      <View
        padding="0px 0px 0px 0px"
        width="800px"
        ...
        top="357px"
        left="320px"
        {...getOverrideProps(overrides, "Browser")}
      >
        <View
          width="800px"
          height="480px"
          ...
          {...getOverrideProps(overrides, "Background0185")}
        ></View>
        <View
          padding="0px 0px 0px 0px"
          width="60px"
        ...
        >
          <Icon
            ...
            top="0px"
            left="0px"
            {...getOverrideProps(overrides, "Button0186")}
          ></Icon>
          <Icon
            width="12px"
            height="12px"
            ...
            top="0px"
            left="24px"
            {...getOverrideProps(overrides, "Button0188")}
          ></Icon>
          <Icon
            width="12px"
            height="12px"
            ...
            top="0px"
            left="48px"
            {...getOverrideProps(overrides, "Button0189")}
          ></Icon>
        </View>
      </View>
      <View
