      ...
      <div className="PersonalCard_personalCardGrid__X950m PersonalCard_personalCard__rGKT1 Leadership_card__IstGO">
        ...
        <div className="PersonalCard_cardInfo__atcMh" style={{ marginTop: '10px' }}>
          <div data-testid="bk-taberoni" className="BkTaberoni-module_bkTaberoni__3CE6z lightCyan">
            <div>
              <h3 className="BkText-module_typeShortSmMd__2Y0v_ BkText-module_bkText__3DMy6 BkText-module_medium__2I-l0 BkTaberoni-module_mainText__3XW3H" style={{ fontSize: '40px' }}>{name}</h3>
              <span className="BkText-module_typeShortSmMd__2Y0v_ BkText-module_bkText__3DMy6 BkText-module_medium__2I-l0 BkType-module_bkType__2QqHN BkTaberoni-module_helperText__32ZRu" style={{ fontWeight: 'bold', '--base-helper-marginTop': '4px', '--md-helper-marginTop': '4px', '--lg-helper-marginTop': '4px', '--xl-helper-marginTop': '4px' }}>{role}</span>
            </div>
          </div>
